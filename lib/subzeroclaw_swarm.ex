defmodule SubzeroclawSwarm do
  @moduledoc """
  SubzeroclawSwarm - An Elixir/OTP orchestrator for managing swarms of subzeroclaw agents.
  ...
  ## Quick Start
      ...
      {:ok, swarm_id} = SubzeroclawSwarm.start_swarm("path/to/config.exs")

      # Send a task to an agent
      SubzeroclawSwarm.send_task(swarm_id, "researcher", "find papers on transformers")

      # Get swarm status
      SubzeroclawSwarm.status(swarm_id)

      # Stop the swarm
      SubzeroclawSwarm.stop_swarm(swarm_id)
