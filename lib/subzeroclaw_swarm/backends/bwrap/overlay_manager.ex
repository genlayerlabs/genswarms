defmodule SubzeroclawSwarm.Backends.Bwrap.OverlayManager do
  @moduledoc """
  ...
  defp resolve_named_preset(presets) do
    ...
    # e.g., Application.put_env(:subzeroclaw_swarm, :extra_preset_dirs, ["/my/presets"])
    search_dirs = [
      @sandbox_bases_dir
      | Application.get_env(:subzeroclaw_swarm, :extra_preset_dirs, [])
    ]
