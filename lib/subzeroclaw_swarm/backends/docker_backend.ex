defmodule SubzeroclawSwarm.Backends.DockerBackend do
  @moduledoc """
  ...
  defp get_project_root do
    Application.get_env(:subzeroclaw_swarm, :project_root, ".")
  end
  ...
  defp build_volume_args(skills_dir, config) do
    ...
    subzeroclaw_src =
      Map.get(config, :subzeroclaw_src) ||
        Application.get_env(:subzeroclaw_swarm, :subzeroclaw_src) ||
