defmodule SubzeroclawSwarm.Backends.LocalBackend do
  @moduledoc """
  ...
  defp get_wrapper_path(config) do
    Map.get(config, :wrapper_path) ||
      Application.get_env(:subzeroclaw_swarm, :wrapper_path) ||
  ...
  defp get_subzeroclaw_path(config) do
    Map.get(config, :subzeroclaw_path) ||
      Application.get_env(:subzeroclaw_swarm, :subzeroclaw_path, "subzeroclaw")
  end
