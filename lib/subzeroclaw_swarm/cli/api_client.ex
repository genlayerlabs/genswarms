defmodule SubzeroclawSwarm.CLI.APIClient do
  @moduledoc """
  ...
  defp request(method, path, body \\ nil) do
    ...
    request_line = "#{method_str} #{uri.path || "/"}#{if uri.query, do: "?#{uri.query}", else: ""} HTTP/1.1\r\n"
    ...
    case :gen_tcp.connect(String.to_charlist(host), port, [:binary, active: false, packet: :raw], 10_000) do
      {:ok, socket} ->
