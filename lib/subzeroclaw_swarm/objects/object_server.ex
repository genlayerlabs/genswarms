defmodule SubzeroclawSwarm.Objects.ObjectServer do
  @moduledoc """
  ...
  **SSH (`{:ssh, host}` or `{:ssh, host, opts}`):**
  ...
  def via_tuple(swarm_name, object_name) do
    {:via, Registry, {SubzeroclawSwarm.AgentRegistry, {swarm_name, object_name}, :object}}
  end
  ...
  defp emit_telemetry(event, state, metadata \\ %{}) do
    :telemetry.execute(
      [:subzeroclaw_swarm, :object, event],
