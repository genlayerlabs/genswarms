defmodule SubzeroclawSwarmWeb.SwarmChannel do
  @moduledoc """
  ...
  use SubzeroclawSwarmWeb, :channel

  alias SubzeroclawSwarm.SwarmManager
  alias SubzeroclawSwarm.CLI.SwarmRegistry
  ...
  def handle_in("subscribe_logs", payload, socket) do
    ...
    Phoenix.PubSub.subscribe(SubzeroclawSwarm.PubSub, topic)
  ...
  def handle_in("unsubscribe_logs", payload, socket) do
    ...
    Phoenix.PubSub.unsubscribe(SubzeroclawSwarm.PubSub, topic)
